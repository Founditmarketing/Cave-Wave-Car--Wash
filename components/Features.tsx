      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <motion.h2
            ...
            className="text-cwCyan font-medium tracking-widest uppercase mb-4 text-lg"
          >
            Why Choose Us
          </motion.h2>
          <motion.h3
            ...
            className="text-5xl md:text-7xl font-medium uppercase text-white mb-6"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h4 className="text-2xl font-medium uppercase text-white mb-4 group-hover:text-cwCyan transition-colors relative z-10">
                {feature.title}
              </h4>
